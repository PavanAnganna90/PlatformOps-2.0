...
import { Box, Mail, Chrome, ArrowRight, Terminal, Cpu, PlayCircle, Loader2 } from 'lucide-react';
...
export const LoginView: React.FC = () => {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Allow fallback for demo/testing if auth isn't configured
      console.error(err);
      alert("Login failed. Please check your Supabase configuration or try Demo Mode.");
    } finally {
      setLoading(false);
    }
  };
